  ...
  group('SHA3Hasher', () {
    ...
    group('hash()', () {
      test('SHA3 (NIST) - 256', () {
        ...
        Uint8List output = SHA3Hasher.hash(input, SignSchema.SHA3, SignSchema.HASH_SIZE_32_BYTES);
        ...
        output = SHA3Hasher.hash(input, SignSchema.SHA3, SignSchema.HASH_SIZE_32_BYTES);
      ...
      test('SHA3 (NIST) - 512', () {
        // test #1
        Uint8List input = HexUtils.getBytes('227F');
        Uint8List output = SHA3Hasher.hash(input, SignSchema.SHA3, SignSchema.HASH_SIZE_64_BYTES);
        ...
        // test #2
        input = HexUtils.getBytes('AAAA');
        output = SHA3Hasher.hash(input, SignSchema.SHA3, SignSchema.HASH_SIZE_64_BYTES);
      ...
      test('SHA3 (KECCAK) - 256', () {
        ...
        // test #2
        input = HexUtils.getBytes('AAAA');
        output = SHA3Hasher.hash(input, SignSchema.KECCAK, SignSchema.HASH_SIZE_32_BYTES);
      ...
      test('KECCAK - 512', () {
        ...
        // test #2
        input = HexUtils.getBytes('AAAA');
        output = SHA3Hasher.hash(input, SignSchema.KECCAK, SignSchema.HASH_SIZE_64_BYTES);
