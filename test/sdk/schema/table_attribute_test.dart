...
library nem2_sdk_dart.test.sdk.schema.table_attribute_test;

import 'dart:typed_data' show Uint8List;

import 'package:test/test.dart';

import 'package:nem2_sdk_dart/sdk.dart' show TableAttribute;

import 'schema_test.dart' show MockSchemaAttribute;

void main() {
  group('TableAttribute', () {
    ...
    test('serialize()', () {
      ...
      final tableAttribute = new TableAttribute('test', [attribute1]);
      final actual = tableAttribute.serialize(buffer, 18, 32);

      expect(tableAttribute.name, equals('test'));
