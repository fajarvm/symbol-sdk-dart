...
library nem2_sdk_dart.test.sdk.schema.scalar_attribute_test;

import 'dart:typed_data' show Uint8List;

import 'package:nem2_sdk_dart/sdk.dart' show ScalarAttribute;
import 'package:test/test.dart';

void main() {
  group('ScalarAttribute', () {
    ...
    test('serialize()', () {
      final scalarAttribute = new ScalarAttribute('test', 4);
      final actual = scalarAttribute.serialize(buffer, 14, 32);

      expect(scalarAttribute.name, equals('test'));
