...
library nem2_sdk_dart.test.sdk.schema.array_attribute_test;

import 'dart:typed_data' show Uint8List;

import 'package:nem2_sdk_dart/core.dart' show ArrayUtils;
import 'package:nem2_sdk_dart/sdk.dart' show ArrayAttribute;
...
void main() {
  group('ArrayAttribute', () {
    ...
    test('serialize()', () {
      final arrayAttribute = new ArrayAttribute('test', 1);
      final actual = arrayAttribute.serialize(buffer, 18, 32);
      ...
      expect(arrayAttribute.name, equals('test'));
