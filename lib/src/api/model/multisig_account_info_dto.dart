...
class MultisigAccountInfoDTO {
  ...
  static List<MultisigAccountInfoDTO> listFromJson(List<dynamic> json) {
    return json == null
        ? <MultisigAccountInfoDTO>[]
        : json.map((value) => new MultisigAccountInfoDTO.fromJson(value)).toList();
  }

  static Map<String, MultisigAccountInfoDTO> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = <String, MultisigAccountInfoDTO>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((key, value) => map[key] = new MultisigAccountInfoDTO.fromJson(value));
    }
    return map;
  }
}
