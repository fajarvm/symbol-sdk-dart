...
class AnnounceTransactionInfoDTO {
  ...
  static List<AnnounceTransactionInfoDTO> listFromJson(List<dynamic> json) {
    return json == null
        ? <AnnounceTransactionInfoDTO>[]
        : json.map((value) => new AnnounceTransactionInfoDTO.fromJson(value)).toList();
  }

  static Map<String, AnnounceTransactionInfoDTO> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = <String, AnnounceTransactionInfoDTO>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((key, value) => map[key] = new AnnounceTransactionInfoDTO.fromJson(value));
    }
    return map;
  }
}
