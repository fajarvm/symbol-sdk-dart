...
class NodeTimeDTO {
  ...
  NodeTimeDTO.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    communicationTimestamps = new CommunicationTimestamps.fromJson(json['communicationTimestamps']);
  }
  ...
  static Map<String, NodeTimeDTO> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = <String, NodeTimeDTO>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((key, value) => map[key] = new NodeTimeDTO.fromJson(value));
    }
    return map;
  }
}
