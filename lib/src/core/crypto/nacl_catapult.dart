...
class Box {
  ...
  Uint8List before() {
    if (this._sharedKey == null) {
      ...
      NaclCatapult.crypto_box_beforenm(
  ...
  Uint8List after_len(
    ...
    if (0 !=
        NaclCatapult.crypto_box_afternm(c, m, m.length, theNonce, _sharedKey))
      return null;
  ...
  Uint8List open_after_len(
    ...
    if (NaclCatapult.crypto_box_open_afternm(
  ...
  static NaclKeyPair keyPair_fromSecretKey(Uint8List secretKey) {
    ...
    NaclCatapult.crypto_scalarmult_base(pk, sk);
    return kp;
  }
}
...
class SecretBox {
  ...
  Uint8List box_nonce_len(
    ...
    if (0 != NaclCatapult.crypto_secretbox(c, m, m.length, theNonce, _key))
      return null;
  ...
  Uint8List open_nonce_len(
    ...
    if (0 != NaclCatapult.crypto_secretbox_open(m, c, c.length, theNonce, _key))
      return null;
...
class ScalarMult {
  ...
  static Uint8List scalseMult(Uint8List n, Uint8List p) {
    ...
    NaclCatapult.crypto_scalarmult(q, n, p);
  ...
  static Uint8List scalseMult_base(Uint8List n) {
    ...
    NaclCatapult.crypto_scalarmult_base(q, n);
...
class Hash {
  ...
  static Uint8List sha512(Uint8List message) {
    ...
    NaclCatapult.crypto_hash(out, message);
...
class Signature {
  ...
  Uint8List sign_len(Uint8List message, final int moff, final int mlen) {
    ...
    NaclCatapult.crypto_sign(sm, -1, message, moff, mlen, _mySecretKey);
  ...
  bool detached_verify(Uint8List message, Uint8List signature) {
    ...
    return (NaclCatapult.crypto_sign_open(
  ...
  static NaclKeyPair keyPair_fromSeed(Uint8List seed) {
    ...
    // generate pk from sk
    NaclCatapult.crypto_sign_keypair(pk, sk, true);
