...
import 'package:nem2_sdk_dart/core.dart' show CryptoException, CryptoUtils, HexUtils, SignSchema;
...
class SecureMessage extends Message {
  ...
  ///
  /// The [message] for the [networkType] is encrypted using a shared key generated by the
  /// [senderPrivateKey] and the [receiverPublicKey]. The receiver can decrypt the message
  /// using this shared key.
  static SecureMessage create(final String message, final Uint8List senderPrivateKey,
      final Uint8List receiverPublicKey, final NetworkType networkType) {
    ...
    final Uint8List sharedKey =
        CryptoUtils.deriveSharedKey(salt, senderPrivateKey, receiverPublicKey, signSchema);
