...
library symbol_sdk_dart.sdk.model.message.encrypted_message;
...
class EncryptedMessage extends Message {
  ...
  static EncryptedMessage create(final String plainTextMessage, final String senderPrivateKey,
    ...
    final String encryptedPayload =
        CryptoUtils.encryptMessage(plainTextMessage, senderPrivateKey, recipientPublicKey);
  ...
  static PlainMessage decrypt(final EncryptedMessage encryptedMessage,
    ...
    final String decrypted =
        CryptoUtils.decryptMessage(encryptedMessage.payload, recipientPrivateKey, senderPublicKey);
