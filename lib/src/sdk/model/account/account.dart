...
class Account {
  ...
  static Account createFromPrivateKey(final String privateKey, final NetworkType networkType) {
    final KeyPair keyPair = KeyPair.createFromPrivateKeyString(privateKey);
    final String rawAddress =
        Address.addressToString(Address.publicKeyToAddress(keyPair.publicKey, networkType));
